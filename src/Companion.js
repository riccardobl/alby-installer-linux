...
// async function main(){
//     console.log(await Companion.getInstalledVersion("/tmp/alby"));
//     const lastRelease=await Companion.getLastRelease();
//     console.log(lastRelease);
//     console.log("Sign",await Companion.download(lastRelease,"/tmp/alby",(unit,progress)=>{
//         console.log("Downloading ",unit," ",Math.floor(progress*100,"%"));
//     }));
// }
